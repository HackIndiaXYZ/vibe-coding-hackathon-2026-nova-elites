...
export const OverviewPage: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col gap-6">
      ...
      <div>
        <h1 className="text-2xl font-light text-white mb-2">Operational Overview</h1>
        <p className="text-slate-400">High-level metrics and recent activity for the current context.</p>
      </div>

      <OverviewStatsGrid metrics={metrics} />

      <div className="flex-1 grid grid-cols-1 xl:grid-cols-3 gap-6 min-h-0">
        <div className="xl:col-span-2 rounded-2xl border border-slate-800 bg-slate-900/40 p-6 flex flex-col items-center justify-center text-center">
          ...
          <h2 className="text-xl font-medium text-white mb-2">Coordination Map Placeholder</h2>
