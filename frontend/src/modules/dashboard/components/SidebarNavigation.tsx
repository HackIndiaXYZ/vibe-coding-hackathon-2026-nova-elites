...
export const SidebarNavigation: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-[var(--color-sidebar)]">
      <div className="h-16 border-b border-[var(--color-border)] flex items-center px-6">
        <h1 className="text-xl font-medium tracking-wide text-[var(--color-text-primary)]">Samanvay</h1>
      </div>
